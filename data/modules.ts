...
Risk | What fear are they avoiding?`,
    ...
    worksheets: [
      ...
      },
      {
        ...
        fields: [
          { id: 'functional-job', label: 'Functional Job', type: 'textarea', required: true },
          { id: 'emotional-job', label: 'Emotional Job', type: 'textarea', required: true },
          { id: 'social-job', label: 'Social Job', type: 'textarea', required: true },
          { id: 'risk-job', label: 'Risk Job', type: 'textarea', required: true },
        ],
      },
    ],
    coldCall: {
